    ...
    ui(new Ui::MaintainceAllPortsPage)
{
    ...
    buttons<<ui->BTN_ACE<<ui->BTN_ATC<<ui->BTN_BCE<<ui->BTN_DDU<<ui->BTN_EDCUA<<ui->BTN_ERM
         ...
         <<ui->BTN_VCUA<<ui->BTN_VCUB<<ui->BTN_Return<<ui->BTN_TDS;
    ui->BTN_VCUB->hide();
    ...
    FASPort<<0x810<<0x820;
    PISPort<<0x910<<0x911<<0x920<<0x921<<0xC28;
    HVACPort<<0xA10<<0xA20<<0xA30<<0xA40;
    ATCPort<<0xB10<<0xB20;
    PCUPort<<0xC10;
    TDSPort<<0xD18<<0xD10<<0xD20<<0xD30<<0xD40;
